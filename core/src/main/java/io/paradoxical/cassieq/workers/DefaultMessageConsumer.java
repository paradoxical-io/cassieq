...
public class DefaultMessageConsumer implements MessageConsumer {
    ...
    private final OnMessageConsumed onMessageConsumed;

    @Inject
    public DefaultMessageConsumer(
            MessageRepoFactory messageRepoFactory,
            MessagePublisher messagePublisher,
            OnMessageConsumed.OnMessageConsumedFactory onMessageConsumedFactory,
        ...
        onMessageConsumed = onMessageConsumedFactory.forQueue(definition);
